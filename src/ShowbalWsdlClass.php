...
/**
 * File for ShowbalWsdlClass to communicate with SOAP service
 * @package Showbal
...
/**
 * ShowbalWsdlClass to communicate with SOAP service
 * 
 * @package Showbal
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-12-25
 */
class ShowbalWsdlClass extends stdClass implements ArrayAccess, Iterator, Countable
{
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://showbal.i-packexpress.com:8101/ShowbalWS.svc?singleWsdl';
    ...
    /**
     * Constructor
     * @uses ShowbalWsdlClass::setLastError()
     * @uses ShowbalWsdlClass::initSoapClient()
     * @uses ShowbalWsdlClass::initInternArrayToIterate()
     * @uses ShowbalWsdlClass::_set()
     ...
     * @return ShowbalWsdlClass|null
     */
    public static function __set_state(array $_array, $_className = __CLASS__)
    {
        if (class_exists($_className)) {
            $object = @new $_className();
            if (is_object($object) && is_subclass_of($object, 'ShowbalWsdlClass')) {
     ...
     * @uses ShowbalClassMap::classMap()
     * @uses ShowbalWsdlClass::getDefaultWsdlOptions()
     * @uses ShowbalWsdlClass::getSoapClientClassName()
     * @uses ShowbalWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if (class_exists('ShowbalClassMap', true)) {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = ShowbalClassMap::classMap();
     ...
     * If a class is named as {Showbal}SoapClient, then this is the class that will be used.
    ...
    {
        if (class_exists('ShowbalSoapClient') && is_subclass_of('ShowbalSoapClient', 'SoapClient'))
            return 'ShowbalSoapClient';
        else
            return 'SoapClient';
    }
     ...
     * @uses ShowbalWsdlClass::WSDL_CACHE_WSDL
     * @uses ShowbalWsdlClass::WSDL_COMPRESSION
     * @uses ShowbalWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses ShowbalWsdlClass::WSDL_ENCODING
     * @uses ShowbalWsdlClass::WSDL_EXCEPTIONS
     * @uses ShowbalWsdlClass::WSDL_FEATURES
     * @uses ShowbalWsdlClass::WSDL_LOGIN
     * @uses ShowbalWsdlClass::WSDL_PASSWORD
     * @uses ShowbalWsdlClass::WSDL_SOAP_VERSION
     * @uses ShowbalWsdlClass::WSDL_STREAM_CONTEXT
     * @uses ShowbalWsdlClass::WSDL_TRACE
     * @uses ShowbalWsdlClass::WSDL_TYPEMAP
     * @uses ShowbalWsdlClass::WSDL_URL
     * @uses ShowbalWsdlClass::VALUE_WSDL_URL
     * @uses ShowbalWsdlClass::WSDL_USER_AGENT
     * @uses ShowbalWsdlClass::WSDL_PROXY_HOST
     * @uses ShowbalWsdlClass::WSDL_PROXY_PORT
     * @uses ShowbalWsdlClass::WSDL_PROXY_LOGIN
     * @uses ShowbalWsdlClass::WSDL_PROXY_PASSWORD
     * @uses ShowbalWsdlClass::WSDL_LOCAL_CERT
     * @uses ShowbalWsdlClass::WSDL_PASSPHRASE
     * @uses ShowbalWsdlClass::WSDL_AUTHENTICATION
     * @uses ShowbalWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses ShowbalWsdlClass::getSoapClient()
     * @uses ShowbalWsdlClass::getFormatedXml()
     ...
     * @uses ShowbalWsdlClass::getSoapClient()
     * @uses ShowbalWsdlClass::convertStringHeadersToArray()
     ...
     * @uses ShowbalWsdlClass::getInternArrayToIterate()
     * @uses ShowbalWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses ShowbalWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses ShowbalWsdlClass::getInternArrayToIterateOffset()
     * @uses ShowbalWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses ShowbalWsdlClass::getInternArrayToIterateOffset()
     * @uses ShowbalWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see ShowbalWsdlClass::offsetGet()
     * @uses ShowbalWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses ShowbalWsdlClass::getAttributeName()
     * @uses ShowbalWsdlClass::__toString()
     * @uses ShowbalWsdlClass::_set()
     * @uses ShowbalWsdlClass::_get()
     * @uses ShowbalWsdlClass::setInternArrayToIterate()
     * @uses ShowbalWsdlClass::setInternArrayToIterateIsArray()
     * @uses ShowbalWsdlClass::setInternArrayToIterateOffset()
